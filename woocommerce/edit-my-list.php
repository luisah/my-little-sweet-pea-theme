...
<div id="wl-wrapper" class="product woocommerce"> <!-- product class so woocommerce stuff gets applied in tabs -->
	...
	<div id="tab-wl-items">
		<?php if (sizeof($wishlist_items) > 0) : ?>
				...
				<table class="shop_table cart wl-table manage" cellspacing="0">
					<thead>
						<tr>
							...
							<th class="product-name"><?php _e('Item', 'wc_wishlist'); ?></th>
								...
								<tr class="cart_table_item">
									...
									<td class="product-purchase">
										<?php if ($_product->is_in_stock()) : ?>
											<a href="<?php echo woocommerce_wishlist_url_item_add_to_cart($wishlist->id, $wishlist_item_key, $wishlist->get_wishlist_sharing() == 'Shared' ? $wishlist->get_wishlist_sharing_key() : false ); ?>" class="button alt">add to my cart</a>
										<?php endif; ?>
									</td>
								</tr>
								<?php
			...
			<div class="grid-right fit col-220 privacy">
				...
				<?php endif; ?>
				<a class="wlconfirm" href="<?php $wishlist->the_url_delete(); ?>"><?php _e('delete list', 'wc_wishlist'); ?></a>
			</div>
...
<strong>What kind of list is this?<abbr class="required" title="required">*</abbr></strong>
        <table class="wl-rad-table">
				...
				<div class="grid-right fit col-460">
					<p class="form-row">
				...
				<div class="clear"></div>
				<p style="margin-bottom: 0"><?php _e('Enter a name you would like associated with this list.  If your list is public, users can find it by searching for this name.', 'wc_wishlist'); ?></p>
				...
				<p class="form-row form-row-first">
					<label for="wishlist_owner_email"><?php _e('E-mail', 'wc_wishlist'); ?></label>
				...
				<p class="form-row">
					<input type="submit" class="button alt button-submit" name="update_wishlist" value="<?php _e('save changes', 'wc_wishlist'); ?>">
				</p>
			</form>
			<div class="wl-clear"></div>
		</div><!-- /wl form -->
